...
OBS_DIR="$HOME/obs/home:smithfarm:branches:Application:Dochazka/$OBS_NAME/"
...
./Build distclean
( cd $OBS_DIR ; osc service dr ; osc add $CPAN_NAME-*.tar.gz ; osc -A https://api.opensuse.org/ commit -m $VERSION ; osc -A https://api.opensuse.org/ sr -m $VERSION )
